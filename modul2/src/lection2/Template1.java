 ...
 * <p>
 * Задачи:
 * 1. У вас есть список строковых значений, и вы должны вернуть список со всеми этими строковыми значениями
 * A. В нижнем регистре (или в верхнем регистре)
 * B. В верхнем регистре (или в верхнем регистре)
 * <p>
...
public class Template1 {
    ...
    public static List task1A(ArrayList<String> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            newList.add(list.get(i).toUpperCase()); // в верхний регистр
        }
        return newList;
    }
    ...
    public static List task1B(ArrayList<String> list) {
        List<String> newList = new ArrayList<>();
        for (int i = 0; i < list.size(); i++) {
            newList.add(list.get(i).toLowerCase()); // в нижний регистр
        }
        return newList;
    }
